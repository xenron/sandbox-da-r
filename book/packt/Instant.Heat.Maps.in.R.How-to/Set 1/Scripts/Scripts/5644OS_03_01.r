...
my_colors1 = c("yellow1",
	"yellow4", 
	"lightblue",
	"cornflowerblue", 
	"tomato", 
	"tomato3")
heat2(col = my_colors1, 
	main = "1.3) Own Color Palette 1")
my_colors2 <- c(y1 = "#F7F7D0", 
	y2 = "#FCFC3A", 
	y3 = "#D4D40D", 
	b1 = "#40EDEA",
	b2 = "#18B3F0", 
	...
	r2 = "#F26666", 
	r1 = "#C70404")
heat2(col = my_colors2, 
	main = "1.3) Own Color Palette 2")
...
print(rounded_fold_changes)

### 3) adding row separators
heat2(rowsep = c(8,20,24,26,32,33,36,38,46), 
	sepwidth = c(0.1,0.1), 
	sepcolor="black",
	main = "3) Row Separators")

### 4) adding column side colors
heat2(ColSideColors = c("red", "gray", "red", rep("green", 13)),
	main = "4) ColSideColors")
